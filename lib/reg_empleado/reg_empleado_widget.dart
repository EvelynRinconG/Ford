...
class RegEmpleadoWidget extends StatefulWidget {
  const RegEmpleadoWidget({Key key}) : super(key: key);

  @override
  _RegEmpleadoWidgetState createState() => _RegEmpleadoWidgetState();
}

class _RegEmpleadoWidgetState extends State<RegEmpleadoWidget> {
              ...
              children: [
                ...
                Align(
                  ...
                  child: FlutterFlowDropDown(
                    options: ['Sucursal 1', 'Sucursal 2', 'Sucursal 3'],
